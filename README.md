...
- **Dynamic Screenplay Editor:** Create and edit scripts with support for Dialogue, Action, and Scene blocks.
- **Advanced TTS Integration:** Powered by the TiSpeech engine, providing unique voices for a diverse cast of characters.
- **Interactive Theater Mode:** Watch your screenplays with automated character positioning, movement, and voice-over.
- **Staging & Splice Modes:** Fine-tune character placement and easily insert script blocks anywhere in the timeline.
- **Rich Asset Library:** Includes a variety backgrounds and character sprites for diverse storytelling.
