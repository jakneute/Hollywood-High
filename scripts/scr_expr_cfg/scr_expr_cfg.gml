...
function expr_cfg_auto_fill(_pose_num, _is_high) {
    ...
    var _cfg_af = datafiles_path + "actors/" + _c_af.name + "/config/";

    var _off_af = load_config_json(_c_af.name, "offsets.json");
...
function save_expr_config() {
    ...
    var _folder_sv = datafiles_path + "actors/" + _c_sv.name + "/config/";
    var _out = {};
